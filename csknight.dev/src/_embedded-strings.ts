...
function tryN(fn, delay, tries) {
  ...
  console.log("trying", fn, delay, tries);
  if(tries && !fn()){
...
export const EXTRA_STYLE_CSS_STRING = `body, html {
  min-height: 100vh;
  margin: 0;
...
.social-footer ul.social-footer-icons .social-icon {
  display:flex;
  flex-direction: row;
  align-items: center;
...
.dark-footer .social-footer ul.social-footer-icons .social-icon {
...
.social-footer ul.social-footer-icons .social-icon:hover {
  background-color: #333333;
}
.dark-footer .social-footer ul.social-footer-icons .social-icon:hover {
